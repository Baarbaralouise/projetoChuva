// Função de click - texto todo do resumo aparecer 
function abrirTexto() {
...
// Função de click - realizar o dropdown de idioma 
function dropdown() {
...
// Função de click - área de discussões 
function topico() {
...
// Função de click - validar o formulário, aparecer a tela de sucesso de envio 
...
// Função de click - editar o tópico enviado 
...
// Funções de click - alterar a quantidade de likes 
function darLike() {
    numero = 1;
    numero++;
...
//  Funções de clicks - mostrar as respostas das discussões 
